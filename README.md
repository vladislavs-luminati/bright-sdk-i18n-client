...
The repository includes a demo `index.html` at the project root (a moved copy of the previous `example/index.html`). Below is the demo HTML (same file) for quick reference:
...
I18n.translateValue('Some string to translate')
    ...
    <script type="module">
      (async () => {
        ...
        try {
          // import local dev module (source during development). When packaging you may import the built bundle.
          const mod = await import('./src/index.js');
          const I18n = mod.I18n || mod.default || mod;
